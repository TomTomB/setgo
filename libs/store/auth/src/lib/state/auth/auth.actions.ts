...
export const fetchSignInMethodsForEmail = createActionGroup({
  ...
  isUnique: true,
  argsTypes: defineArgTypes<{args: Models.FetchSignInMethodsForEmailArgs; response: string[];}>(),
});
...
export const signInWithEmailAndPassword = createActionGroup({
  ...
  isUnique: true,
  argsTypes:
      defineArgTypes<{args: Models.SignInWithEmailAndPasswordArgs; response: FirebaseUser;}>(),
});
...
export const signOut = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: null; response: null;}>(),
});
...
export const createUserWithEmailAndPassword = createActionGroup({
  ...
  isUnique: true,
  argsTypes:
      defineArgTypes<{args: Models.CreateUserWithEmailAndPasswordArgs; response: FirebaseUser;}>(),
});
...
export const sendPasswordResetEmail = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: Models.SendPasswordResetEmailArgs; response: null;}>(),
});
...
export const getUserIdToken = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: Models.GetUserIdTokenArgs; response: string;}>(),
});
...
export const reloadUser = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: null; response: FirebaseUser;}>(),
});
...
export const updateUserEmail = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: Models.UpdateUserEmailArgs; response: null;}>(),
});
...
export const updateUserPassword = createActionGroup({
  ...
  scope: AUTH_ACTION_PREFIX,
  isUnique: true,
  argsTypes: defineArgTypes<{args: Models.UpdateUserPasswordArgs; response: null;}>(),
});
