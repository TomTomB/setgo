...
describe('AuthEffects', () => {
  ...
  describe('fetchSignInMethodsForEmail$', () => {
    it(
      ...
      marbles((m) => {
        ...
        jest
          .spyOn(authService, 'fetchSignInMethodsForEmail')
  ...
  describe('getUserIdToken$', () => {
    ...
    it(
      ...
      marbles((m) => {
        ...
        jest
          .spyOn(authService, 'getUserIdToken')
          .mockReturnValue(throwError(firebaseError));
  ...
  describe('sendUserEmailVerification$', () => {
    it(
      ...
      marbles((m) => {
        jest
          .spyOn(authService, 'sendUserEmailVerification')
          .mockReturnValue(of(null));
  ...
  describe('signInWithEmailAndPassword$', () => {
    it(
      ...
      marbles((m) => {
        ...
        jest
          .spyOn(authService, 'signInWithEmailAndPassword')
          .mockReturnValue(of(firebaseUser));
  ...
  describe('updateUserEmail$', () => {
    ...
    it(
      ...
      marbles((m) => {
        ...
        jest
          .spyOn(authService, 'updateUserEmail')
          .mockReturnValue(throwError(firebaseError));
  ...
  describe('updateUserPassword$', () => {
    ...
    it(
      ...
      marbles((m) => {
        ...
        jest
          .spyOn(authService, 'updateUserPassword')
          .mockReturnValue(throwError(firebaseError));
