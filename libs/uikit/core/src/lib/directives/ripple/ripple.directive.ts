...
export class RippleDirective implements OnInit, OnDestroy, RippleTarget {
  /** Custom color for all ripples. */
  @Input('uikitCoreRippleColor')
  color?: string;

  /** Whether the ripples should be visible outside the component's bounds. */
  @Input('uikitCoreRippleUnbounded')
  unbounded?: boolean;
   ...
   */
  @Input('uikitCoreRippleAnimation')
  animation?: RippleAnimationConfig;
